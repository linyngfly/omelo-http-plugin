...
Http.prototype.start = function (cb) {
  ...
  if (this.opts.static && this.opts.static.enable) {
    let defaultRoot = path.join(this.app.getBase(), 'app/servers', this.app.getServerType(), 'public');
    this.http.use(require('koa-static')(this.opts.static.root || defaultRoot, this.opts.static.opts));
  }
